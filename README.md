...
| [**3: JS Fundamentals I**](/unit-3) | 13 | ✔️ | Coders learn about variables, DOM manipulation and event handlers to create a Choose Your Own Adventure game. |
...
| [**5: JS Fundamentals II**] | 12 | ✔️ | Coders will learn how to use .value, string concatenation, and how to write conditionals to create a quiz web app. |
| [**6: JS Fundamentals III**] | 8 | ✔️ | Coders will learn arrays, array methods, loops, and properties to build a movie, tv, or music suggestion app. |
| [**7: End of Year Unit**] | 1 | ➖ | Coders will take an End of Year Coding Challenge and celebrate their accomplishments this year! |
| [**8: Functions (Optional)**] | 10 | ✔️ | Students will learn about functions to create a playlist project. |
