...
| [**4: JS Fundamentals II**] | 12 | ✔️ | Coders will learn how to use .value, string concatenation, and how to write conditionals to create a quiz web app. |
...
| [**6: Functions (Optional)**] | 10 | ✔️ | Students will learn about functions to create a playlist project. |
